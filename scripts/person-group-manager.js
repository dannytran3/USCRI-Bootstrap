...
$(function () {
    ...
    var personsFound,
        ...
        personsInGroup,
        groupsInClient,
        oldName; // group name before renaming
    ...
    $('#addPerson').click(function () {
        ...
        group.persons.add(personsFound[$('#personsFoundList').val()]).then(
            addPersonSuccess, addPersonFail
        );
    });
    ...
    $('#removePerson').click(function () {
        var groupName = $('#groupList').val(),
            person = personsInGroup[$('#personList').val()];
    ...
    $('#removeFromAll').click(function () {
        var i, g,
            person = personsInGroup[$('#personList').val()],
            gs = client.personsAndGroupsManager.all.groups();
